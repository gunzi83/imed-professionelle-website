...
/**
 * Anti-Email Obfuscation Function
 * Ensures email addresses are displayed correctly
 */
function initEmailDisplay() {
    // Get all elements with data-email attribute
    ...
    console.log('✅ Email display initialized');
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initEmailDisplay(); // Fix email display first
